      ...
      {smMenu ?
        <div className='md:hidden grid text-base items-center justify-end w-full text-right'>
          <div className='grid justify-center w-full font-bold'>
            <NavLink to="/" className=" text-blue-900 font-bold mb-4 cursor-pointer">Profile</NavLink>
            <Link to='/doctorprofile' className="text-white w-fit font-bold items-center bg-blue-900 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded hover:text-blue-900 text-base mb-8">Sign Out
            </Link>
          </div>
        </div>
        : ""}
      ...
      <div className='hidden text-base md:flex items-center justify-end text-right w-full'>
        ...
        {mdMenu ?
          <div className='px-4 mr-8 flex flex-col'>
            <NavLink to="/doctorprofile" className=" text-blue-900 font-bold cursor-pointer mb-4">Profile</NavLink>
