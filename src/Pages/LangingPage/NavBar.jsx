  ...
  return (
    <div className="mx-auto p-5 flex items-center justify-between flex-wrap bg-white/40">
      ...
      <div className='flex justify-between w-full md:w-auto items-center'>
        <NavLink className="title-font font-medium flex items-center mb-4 md:mb-0">
      ...
      {menuState ?
        <div className=' md:hidden grid w-full text-center'>
          ...
          <nav className="text-base grid justify-center w-full font-bold text-white">
            <NavLink className="mb-4 hover:border-b-2 w-full font-bold ">Home</NavLink>
            <NavLink className="mb-4 hover:border-b-2 w-full font-bold ">About</NavLink>
            <NavLink className="mb-4 hover:border-b-2 w-full font-bold ">Contact</NavLink>
          </nav>
      ...
      <div className='hidden md:flex items-center justify-center'>
        ...
        <nav className="text-base justify-center flex">
          <NavLink className="mr-5 text-white font-bold">Home</NavLink>
          <NavLink className="mr-5 text-white font-bold">About</NavLink>
          <NavLink className="mr-5 text-white font-bold">Contact</NavLink>
        </nav>

        <button className="text-white font-bold items-center bg-blue-900 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded hover:text-blue-900 text-base mt-4 md:mt-0">Sign In
        </button>
      </div>
